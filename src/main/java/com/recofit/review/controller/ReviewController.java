...
public class ReviewController {
  ...
  public ResponseEntity<Response> getReviews(@RequestHeader(value = "User-Id") Long uId, @RequestHeader(value = "User-Type") String uType, @RequestParam(required = false, value = "target-type") TargetType targetType) {
    Long userId = (Long) uId;
    UserType userType  = UserType.USER;

    if("TRAINER".equals(uType)) {
      userType = UserType.TRAINER;
    }

    if("GYMOWNER".equals(uType)) {
